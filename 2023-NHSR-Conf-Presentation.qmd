...
![](purrr_logo.png){fig-align="center"}
...
`purrr::map(your_raw_material, function_containing_your_instructions)`
...
Tom Jemmett's excellent video on purrr:  
<https://youtu.be/GxvccD8K49M>
